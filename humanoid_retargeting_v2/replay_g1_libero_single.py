...
def main():
    ...
    src_robot_name = "franka"
    # global global_step, tot_success, tot_give_up
    handler_class = get_sim_env_class(SimType("isaaclab"))
    task_name = "libero_pick_alphabet_soup"
    ...
    # 准备录像保存器
    # init_states[0]['objects'] = init_states[0]['objects'].popitem()
    obs, extras = env.reset(states=init_states)
    obs_saver = ObsSaver(video_path=f"./humanoid_retargeting_v2/output/replay_g1_graspnet_actions/calvin/{task_name}.mp4")
