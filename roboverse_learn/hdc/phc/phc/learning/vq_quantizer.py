...
class EmbeddingEMA(nn.Module):
    def __init__(self, num_tokens, codebook_dim, decay=0.99, eps=1e-5):
        ...
        )  # counts for how many times the code is used.
    ...
    def embed_avg_ema_update(self, new_emb_avg):
        ...
        self.embed_avg.data[self.update_idxes] = (
            self.embed_avg.data[self.update_idxes]
            .mul_(self.decay)
            .add(new_emb_avg[self.update_idxes], alpha=1 - self.decay)
        )
    ...
    def weight_update(self, num_tokens):
        ...
        embed_normalized[self.update_idxes] = (
            self.embed_avg[self.update_idxes] / smoothed_cluster_size.unsqueeze(1)[self.update_idxes]
        )
