...
from ...core import SO3, Tensor, Vector3D
from ..skeleton3d import SkeletonState, SkeletonTree

tpose = np.load("/home/serfcx/DL_Animation/rl_mimic/data/skeletons/flex_tpose.npy").item()
...
local_translation = Vector3D.from_numpy(skeleton_tree["local_translation"], dtype="float32")
...
skeleton_state.to_file("/home/serfcx/DL_Animation/rl_mimic/data/skeletons/flex_tpose_new.npy")
