...
import numpy as np
import torch
from .diffusion_policy.diffusion_policy.workspace.robotworkspace import RobotWorkspace
...
class DPRunner(PolicyRunner):
    ...
    def _init_policy(self, **kwargs):
        ...
        cfg = payload["cfg"]
        cfg._target_ = "algorithms.diffusion_policy.diffusion_policy.workspace.robotworkspace.RobotWorkspace"
