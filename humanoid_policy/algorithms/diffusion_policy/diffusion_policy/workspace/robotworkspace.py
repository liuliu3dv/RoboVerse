...
class RobotWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # configure model
        # chuhao, why not useful?
        cfg.policy._target_ = "algorithms.diffusion_policy.diffusion_policy.policy.diffusion_unet_image_policy.DiffusionUnetImagePolicy"
        cfg.policy.obs_encoder._target_ = "algorithms.diffusion_policy.diffusion_policy.model.vision.multi_image_obs_encoder.MultiImageObsEncoder"
        cfg.policy.obs_encoder.rgb_model._target_ = "algorithms.diffusion_policy.diffusion_policy.model.vision.model_getter.get_resnet"
