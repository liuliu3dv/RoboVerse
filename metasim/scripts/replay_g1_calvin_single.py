...
def main():
    ...
    init_franka_pos = init_states[0]['robots']['franka']["pos"]
    init_franka_rot = init_states[0]['robots']['franka']["rot"]
    ...
    obs_saver = ObsSaver(video_path=f"./metasim/scripts/replay_g1_calvin_actions/calvin/{task_name}.mp4")
