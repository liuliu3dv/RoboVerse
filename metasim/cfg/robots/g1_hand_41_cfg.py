...
@configclass
class G1Hand41Cfg(BaseRobotCfg):
    name: str = "g1"
    num_joints: int = 41
    ...
    actuators: dict[str, BaseActuatorCfg] = {
        ...
        'left_hand_thumb_0_joint': BaseActuatorCfg(stiffness=40, damping=10),
        'left_hand_thumb_1_joint': BaseActuatorCfg(stiffness=40, damping=10),
        'left_hand_thumb_2_joint': BaseActuatorCfg(stiffness=40, damping=10),
        'left_hand_middle_0_joint': BaseActuatorCfg(stiffness=40, damping=10),
        ...
        'right_hand_thumb_0_joint': BaseActuatorCfg(stiffness=40, damping=10),
        'right_hand_thumb_1_joint': BaseActuatorCfg(stiffness=40, damping=10),
        'right_hand_thumb_2_joint': BaseActuatorCfg(stiffness=40, damping=10),
        'right_hand_middle_0_joint': BaseActuatorCfg(stiffness=40, damping=10),
        'right_hand_middle_1_joint': BaseActuatorCfg(stiffness=40, damping=10),
    ...
    feet_links: list[str] = ["ankle_roll_link"]
