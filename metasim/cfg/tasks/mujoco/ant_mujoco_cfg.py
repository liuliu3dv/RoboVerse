...
@configclass
class AntMujocoCfg(BaseTaskCfg):
    """Ant locomotion task configuration for MuJoCo simulator.

    This task involves controlling an 8-DOF ant robot to walk forward
    while maintaining balance. The task is designed specifically for
    MuJoCo physics simulation.
    """

    name = "mujoco:AntMujoco"
    episode_length = 1000
    traj_filepath = None
