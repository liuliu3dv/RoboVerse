...
@configclass
class ShadowHandPenCfg(BaseRLTaskCfg):
    """class for bidex shadow hand pen tasks."""
    ...
    def set_init_states(self) -> None:
        """Set the initial states for the shadow hand pen task."""
...
def compute_hand_reward(
    ...
    success = torch.norm(pen_right_handle_pos - pen_left_handle_pos, p=2, dim=-1) * 5 > 1.5
