...
@configclass
class ShadowHandKettleCfg(BaseRLTaskCfg):
    """class for bidex shadow pour water tasks."""
    ...
    kettle_handle_name = "base"
    kettle_handle_idx = None  # Index of the handle in the body state
    bucket_handle_name = "base"
    bucket_handle_idx = None  # Index of the handle in the body state
        ...
        self.init_states = {
                ...
                "robots": {
                    "shadow_hand_right": {
                        ...
                        "rot": torch.tensor([0.707, 0.0, -0.707, 0.]),
                        "dof_pos": {
                            "robot0_WRJ1": 0.0,
                            "robot0_WRJ0": 0.0,
                            "robot0_FFJ3": 0.0,
    ...
    def reward_fn(
        ...
        kettle_spout_pos = envstates.objects["kettle"].body_state[:, self.kettle_handle_idx, :3]
        kettle_spout_rot = envstates.objects["kettle"].body_state[:, self.kettle_handle_idx, 3:7]
