...
from metasim.cfg.robots.quadcopter_cfg import QuadcopterCfg
...
@configclass
class QuadcopterCfg(BaseTaskCfg):
    name = "isaacgym_envs:Quadcopter"
    episode_length = 400
    traj_filepath = None
    ...
    force_scale = 0.5
    force_prob_range = (0.3, 0.6)
    force_decay = 0.99
    force_decay_interval = 0.08

    robot: QuadcopterCfg = QuadcopterCfg()
