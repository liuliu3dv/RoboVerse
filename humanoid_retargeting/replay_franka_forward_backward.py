...
def main():
    ...
    obs_saver = ObsSaver(video_path=f"./humanoid_retargeting/replay_franka_v2/replay_{args.sim}.mp4")
    ...
    inds = [src_robot_links_names.index(franka_franka[name]) for name in target_link_names]
